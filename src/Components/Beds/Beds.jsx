            ...
            <div className="col-lg-6 col-md-12 col-sm-12">
              <div className="furniture-detail">
                ...
                <p>
                  ...
                  promising nights of unparalleled rest.
                </p>
          ...
          <TabsComponent>
            <div label="Discription">
              <div className="tabs-detail">
                ...
                <p>
                  Blending modern flair with timeless allure, the Elegante bed
                  collection captivates with its unique fusion of contemporary
                  and traditional aesthetics. The Elegante bed, featuring a
                  graceful quilted design, exudes sophistication with its sturdy
                  wooden frame and ornate gold metal embellishments gracing the
                  headboard. A symbol of refined elegance and opulent comfort,
                  the Elegante bed transforms any bedroom into a sanctuary of
                  elevated style and luxury.
                </p>
                <h4>Features</h4>
                <ul>
