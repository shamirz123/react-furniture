          ...
          <div className="row">
                        ...
                        <div className="carousel-inner cus-carousel-inner">
                          ...
                          >
                            <div className='d-flex justify-content-center align-item-center' style={{
                              ...
                              <img src="/assets/img/bed-2.jpeg" style={{
                                width: "100%",
                                height: "auto"
                              }} />
                            </div>
                          ...
                          <div className="carousel-item">
                            <div className='d-flex justify-content-center align-item-center' style={{
                              ...
                              <img src="/assets/img/bed-3.jpeg" style={{
                                width: "100%",
                                height: "auto"
                              }} />
                            </div>
                          ...
                          <div className="carousel-item">
                            <div className='d-flex justify-content-center align-item-center' style={{
                              ...
                              <img src="/assets/img/bed-1.jpeg" style={{
                                width: "100%",
                                height: "auto"
                              }} />
                            </div>
                          ...
                          <div className="carousel-item" >
                            <div className='d-flex justify-content-center align-item-center' style={{
                              ...
                              <img src="/assets/img/slider-bed.webp" style={{
                                width: "100%",
                                height: "auto"
                              }} />
                            </div>
                          ...
                          <div className="list-inline-item active carousel-immg">
                            <a id="carousel-selector-4" data-slide-to="3" data-target="#custCarousel">
                              <div
                                className='small-images'
                                style={{
                                  background: "url(/assets/img/slider-bed.webp)",
                                }}
                              ></div>
                            </a>
                          </div>
            ...
            <div className="col-lg-6 col-md-12 col-sm-12">
              <div className='furniture-detail'>
                ...
                <p>
                  Indulge in opulent relaxation with our exquisite collection of beds, available in a variety of luxurious finishes and styles. Immerse yourself in comfort with our sumptuous velvet beds, adorned with soft upholstery in a spectrum of lavish shades, promising nights of unparalleled rest. Alternatively, embrace timeless sophistication with our classic bed designs, meticulously crafted from premium materials to infuse your bedroom with enduring elegance and versatility. Whichever option you select, our beds are meticulously designed to transform your sleeping sanctuary into a haven of unparalleled comfort and style
                </p>
          ...
          <TabsComponent>
            ...
            <div label="Discription">
              <div className='tabs-detail'>
                ...
                <p>Blending modern flair with timeless allure, the Elegante bed collection captivates with its unique fusion of contemporary and traditional aesthetics. The Elegante bed, featuring a graceful quilted design, exudes sophistication with its sturdy wooden frame and ornate gold metal embellishments gracing the headboard. A symbol of refined elegance and opulent comfort, the Elegante bed transforms any bedroom into a sanctuary of elevated style and luxury.</p>
                <h4>Features</h4>
                <ul>
