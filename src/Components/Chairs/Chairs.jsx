          ...
          <div className="row">
                        ...
                        <div className="carousel-inner cus-carousel-inner">
                          ...
                          >
                            <div className='d-flex justify-content-center align-item-center' style={{
                              ...
                              <img src="/assets/img/dining-chair-4.webp" style={{
                                width: "100%",
                                height: "auto"
                              }} />
                            </div>
                          ...
                          <div className="carousel-item">
                            <div className='d-flex justify-content-center align-item-center' style={{
                              ...
                              <img src="/assets/img/dining-chair-1.webp" style={{
                                width: "100%",
                                height: "auto"
                              }} />
                            </div>
                          ...
                          <div className="carousel-item">
                            <div className='d-flex justify-content-center align-item-center' style={{
                              ...
                              <img src="/assets/img/dining-chair-3.webp" style={{
                                width: "100%",
                                height: "auto"
                              }} />
                            </div>
                          ...
                          <div className="carousel-item" >
                            <div className='d-flex justify-content-center align-item-center' style={{
                              ...
                              <img src="/assets/img/dining-chair-2.webp" style={{
                                width: "100%",
                                height: "auto"
                              }} />
                            </div>
                          ...
                          <div className="list-inline-item active carousel-immg">
                            <a id="carousel-selector-0" data-slide-to="0" data-target="#custCarousel">
                              <div
                                ...
                                style={{
                                  background: "url(/assets/img/dining-chair-4.webp)",
                                }}
                              ></div>
                            </a>
                          </div>
                          <div className="list-inline-item active carousel-immg">
                            <a id="carousel-selector-1" data-slide-to="1" data-target="#custCarousel">
                              <div
                                className='small-images'
                                style={{
                                  background: "url(/assets/img/dining-chair-1.webp)",
                                }}
                              ></div>
                            </a>
                          </div>
                          <div className="list-inline-item active carousel-immg">
                            <a id="carousel-selector-2" data-slide-to="2" data-target="#custCarousel">
                              <div
                                className='small-images'
                                style={{
                                  background: "url(/assets/img/dining-chair-3.webp)",
                                }}
                              ></div>
                            </a>
                          </div>
                          <div className="list-inline-item active carousel-immg">
                            <a id="carousel-selector-4" data-slide-to="3" data-target="#custCarousel">
                              <div
                                className='small-images'
                                style={{
                                  background: "url(/assets/img/dining-chair-2.webp)",
                                }}
                              ></div>
                            </a>
                          </div>
            ...
            <div className="col-lg-6 col-md-12 col-sm-12">
              <div className='furniture-detail'>
                ...
                <p>Sink into luxury with our stunning velvet dining chair. The plush upholstery in a rich black hue offers unparalleled comfort, while the sleek gold legs add a touch of modern elegance.This versatile chair elevates any dining space, perfect for entertaining guests or enjoying a quiet meal
                </p>
          ...
          <TabsComponent>
            ...
            <div label="Discription">
              <div className='tabs-detail'>
                ...
                <p>Blending modern and classical aesthetics, the Elegante dining room chairs make a distinctive statement with their unique chair designs. The Elegante chair with arms, featuring a standout quilted design, exudes an elegant appearance with its natural solid legs and gold metal rings adorning the back of the chair.</p>
                <h4>Features</h4>
                <ul>
